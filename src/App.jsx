...
function ClientApp({ user, onLogout }) {
  ...
  // NOTA: estas duas funções foram anteriormente colocadas por engano dentro
  // do componente App de nível superior, onde 'profile', 'setProfile' e
  // 'setShowManual' não existem — isso causava "ReferenceError: handleCloseManual
  // is not defined" assim que o manual tentava fechar (o UserManual é renderizado
  // dentro de ClientApp, e chamava uma função que só existia no escopo do
  // componente pai App, invisível aqui). Movidas para o escopo correcto.
